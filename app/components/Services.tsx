...
export default function Services() {
  ...
  return (
    <section id="services" className="scroll-mt-16 sm:scroll-mt-20" aria-labelledby="services-heading">
      ...
      {/* Divider strip */}
      <div className="border-y border-border bg-gradient-to-r from-primary/5 via-primary/10 to-primary/5">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <span className="text-sm font-bold tracking-[0.15em] uppercase text-primary">Our Services</span>
            <span className="text-sm text-foreground/60 font-medium sm:text-right">Transportation solutions for every need</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        {/* Section header */}
        <div className="mb-10">
          <h2 id="services-heading" className="text-3xl md:text-4xl font-bold tracking-tight leading-tight mb-8">
            Our Services
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div className="bg-card border border-border p-6">
              <p className="text-foreground/70 leading-relaxed text-base mb-5">
                Pathway Transportation Services provides non-emergency medical transportation in the Columbus, Ohio area including <span className="font-medium text-foreground">Westerville, Reynoldsburg, Grove City, Dublin</span>, and nearby communities.
              </p>

              {/* Stats/Features vertical list */}
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-semibold text-foreground">Ohio Medicaid Provider</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded-full border-2 border-primary bg-primary flex items-center justify-center shrink-0">
                    <svg className="w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
                  ...
                  <span className="font-semibold text-foreground">Active NPI</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded-full border-2 border-primary bg-primary flex items-center justify-center shrink-0">
                    <svg className="w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
                  ...
                  <span className="font-semibold text-foreground">EMFTS-Certified Vehicles</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded-full border-2 border-primary bg-primary flex items-center justify-center shrink-0">
                    <svg className="w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
